...
var popover = function () {
    var $code, $mask,
        $btngiftcode, $btnstart, $rewarded, $lottery, $failed, $close, $successed, $btnlottery,$btnsign,$btnviewbox,$giftbox,
        $flag = false, $timer;
    ...
    return {
        init: function () {
            ...
            $lottery = $(".anniversary-popover-lottery");//抽奖
