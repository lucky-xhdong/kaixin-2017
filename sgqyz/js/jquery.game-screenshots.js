...
(function ($) {
    var SlideJieTu = function (o, options) {
        this.o = $("#" + o);
        if (typeof(options) == 'object') {
            this.options = $.extend({}, SlideJieTu.options, options);
        }

        this.init();
    };
    SlideJieTu.prototype = {
        init: function () {
